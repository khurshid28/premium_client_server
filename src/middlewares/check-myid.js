  ...
  try {
    ...
    if (!client.verified) {
      ...
      await new Promise(function (resolve, reject) {
        db.query(
          `update client set fullname=${clientData.fullname},phoneNumber=${clientData.phoneNumber},passport=${clientData.passport},birth_date=${clientData.birth_date}   WHERE id=${req.user.id};`,
          function (err, results, fields) {
            if (err) {
              console.log(err);
              resolve(null);
